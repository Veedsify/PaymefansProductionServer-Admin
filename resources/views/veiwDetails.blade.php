                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <button class="text-secondary-light d-flex me-8">
                                <iconify-icon icon="mingcute:arrow-left-line"
                                    class="icon fs-3 line-height-1"></iconify-icon>
                            </button>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <button class="text-secondary-light d-flex">
                                <iconify-icon icon="material-symbols:delete-outline"
                                    class="icon text-xxl line-height-1"></iconify-icon>
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-20">
                                        ...
                                        <p class="mb-16 text-primary-light">Just confirming that we transferred $63.86 to
                                            you via PayPal <a href="{{ route('javascript:void(0)"
                                                class="text-primary-600 text-decoration-underline">(info367@gmail.com)</a>
                                            which you earned on the themewow Market since your last payout.</p>
                    ...
                    <div class="card-footer py-16 px-24 bg-base shadow-top">
                        <form action="#">
                            <div class="d-flex align-items-center justify-content-between">
                                <textarea class="textarea-max-height form-control p-0 border-0 py-8 pe-16 resize-none scroll-sm"
