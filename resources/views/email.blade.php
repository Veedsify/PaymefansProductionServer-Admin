                    ...
                    <div class="mt-16">
                        ...
                        <div class="mt-24">
                            ...
                            <ul>
                                <li class="mb-20">
                                    <span
                                        class="line-height-1 fw-medium text-secondary-light text-sm d-flex align-items-center gap-10">
                            ...
                            <div class="form-check style-check d-flex align-items-center">
                                ...
                                <div class="dropdown line-height-1">
                                    <button type="button" data-bs-toggle="dropdown" aria-expanded="false"
                                        ...
                                        <iconify-icon icon="typcn:arrow-sorted-down"
                                            class="icon line-height-1"></iconify-icon>
                                    </button>
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg p-12 border bg-base shadow">
                                    <li>
                                        <button type="button"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#exampleModalView">
                                            <iconify-icon icon="gravity-ui:envelope-open"
                ...
                <div class="card-body p-0">
                    <ul class="overflow-x-auto">
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Jerome Bell</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                                dapibus</a>
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Kristin Watson</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Cody Fisher</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Dianne Russell</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Floyd Miles</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Devon Lane</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Annette Black</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Bessie Cooper</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Courtney Henry</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
                        ...
                        <li
                            ...
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium text-md text-line-1 w-190-px">Wade Warren</a>
                            <a href="{{ route('veiwDetails') }}"
                                class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar
                                vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam
                                pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu
