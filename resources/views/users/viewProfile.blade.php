...
@section('main_title', 'View Profile ' . $user->name)
                ...
                <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                    ...
                    <div class="mt-24">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center gap-1 mb-12">
                                <span class="w-30 text-md fw-semibold text-primary-light"> Model</span>
                                <span class="w-70 text-secondary-light fw-medium">:
                                    {{ $user->is_model ? 'Model' : 'Not Model' }}
                                </span>
                            </li>
                            <li class="d-flex align-items-center gap-1 mb-12">
                                <span class="w-30 text-md fw-semibold text-primary-light"> Is Verified</span>
                                <span class="w-70 text-secondary-light fw-medium">:
