...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        Route::get('chat/{conversationId}', 'conversations')->name('conversations');
...
// invoice/invoiceList
    Route::prefix('invoice')->group(function () {
        Route::controller(InvoiceController::class)->group(function () {
            ...
            Route::get('/invoice-list', 'invoiceList')->name('pointsPurchase');
...
// Users
    Route::prefix('users')->group(function () {
        Route::controller(UsersController::class)->group(function () {
            ...
            Route::get('/view-profile/{username}', 'viewProfile')->name('viewProfile');
        });
    });
...
Route::prefix('authentication')->group(function () {
    Route::controller(AuthenticationController::class)->group(function () {
        ...
        Route::post('/signin', 'signInUser')->name('signin');
