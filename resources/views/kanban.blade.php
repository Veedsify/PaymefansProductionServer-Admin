        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll(".add-kanban, .add-task-button").forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    document.getElementById("taskImagePreview").style.display =
                    "none"; // Hide image preview
                ...
                if (editTaskId) {
                    ...
                    if (targetKanbanItem) {
                        ...
                        if (firstKanbanCard) {
                            ...
                            targetKanbanItem.querySelector(".card-body").insertAdjacentHTML("afterbegin",
                                kanbanCardHTML);
                        }
                    }
                }
            ...
            document.addEventListener("click", function(e) {
                if (e.target.closest(".card-edit-button")) {
                    ...
                    document.getElementById("taskTitle").value = card.querySelector(".kanban-title")
                        .textContent;
                    document.getElementById("taskDescription").value = card.querySelector(".kanban-desc")
                        .textContent;
                    document.getElementById("taskTag").value = card.querySelector(".kanban-tag")
                    .textContent;
                    document.getElementById("startDate").value = card.querySelector(".start-date")
                        .textContent;
                            ...
                            <div class="connectedSortable ps-24 pt-24 pe-24" id="sortable1">
                                <div class="kanban-card bg-neutral-50 p-16 radius-8 mb-24" id="kanban-1">
                                    <div class="radius-8 mb-12 max-h-350-px overflow-hidden">
                                        <img src="{{ asset('assets/images/kanban/kanban-1.png') }}" alt=""
                                            class="w-100 h-100 object-fit-cover">
                                    </div>
                                    <h6 class="kanban-title text-lg fw-semibold mb-8">Creating a new website</h6>
                                    <p class="kanban-desc text-secondary-light">Lorem ipsum dolor sit amet, consectetur
                                ...
                                <div class="kanban-card bg-neutral-50 p-16 radius-8 mb-24" id="kanban-2">
                                    <div class="radius-8 mb-12 max-h-350-px overflow-hidden">
                                        <img src="{{ asset('assets/images/kanban/kanban-2.png') }}" alt=""
                                            class="w-100 h-100 object-fit-cover">
                                    </div>
                                    <h6 class="kanban-title text-lg fw-semibold mb-8">Creating a new website</h6>
                                    <p class="kanban-desc text-secondary-light">Lorem ipsum dolor sit amet, consectetur
                ...
                <div class="modal-body">
                    <form id="taskForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Event Title " id="taskTitle"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="taskTag"
                        ...
                        <div class="mb-3">
                            ...
                            <img id="taskImagePreview" src="assets/images/carousel/carousel-img1.png') }}"
                                alt="Image Preview">
                        </div>
                    </form>
                </div>
